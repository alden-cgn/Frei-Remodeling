This is Frei Remodeling's Media library. This is being used to offload the wordpress server of having to host image files and instead are serving images via JSDeliver CDN.
